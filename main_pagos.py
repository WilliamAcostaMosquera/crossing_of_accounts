...
class ExpenseTracker:
    def __init__(self, root):
        ...
        self.user1_radio = ttk.Radiobutton(self.user_frame, text="Allison", variable=self.user_var, value="Usuario 1")
        self.user1_radio.grid(row=0, column=1, padx=5, pady=5)
        self.user2_radio = ttk.Radiobutton(self.user_frame, text="William", variable=self.user_var, value="Usuario 2")
